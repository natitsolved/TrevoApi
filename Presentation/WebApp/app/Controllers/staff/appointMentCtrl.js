...
app.controller('appointMentCtrl', function ($rootScope, $scope, $http,
    ...
    $scope.backFunction = function () {
        $state.go('staff.appointMentList', {}, { reload: true });
    }

    $scope.save = function () {
        $("#default_loader").show();
        if ($scope.item.AppointmentDate && $scope.item.DoctorID && $scope.item.PatientID && $scope.item.ScheduledApptmntTime) {
         ...
         function (errorMessage) {
             $("#default_loader").hide();
             $rootScope.showToast(errorMessage.Message, "alert alert-danger");
         ...
         function (errorMessage) {
            ...
            $("#default_loader").hide();
            $rootScope.showToast("Doctor , Patient,AppointMent Date and Expected Scheduled Time are required.", "alert alert-danger");
        }
    }
